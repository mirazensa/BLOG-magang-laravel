        ...
        <div class="card mt-3">
            <div class="card-body px-4">
                <div class="d-flex justify-content-between col-lg">
                    <h1 class="mt-2 mb-4">Kategori edit</h1>
                    <div class="mt3">
                ...
                <div class="col-lg">
                    ...
                    @elseif($errors->any())
                        <div class="alert alert-danger">{{ 'edit kategori gagal' }}</div>
                    @endif
                    <form action="/dashboard/kategori/{{ $data->id }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" id="kategori" value="{{ old('nama', $data->nama) }}" onkeyup="getSlug()">
                            @error('nama')
