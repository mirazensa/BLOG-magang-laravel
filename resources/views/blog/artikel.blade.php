...
@section('content')
    <div class="col-lg-8">
        @if ($articles->count())
            ...
            <!-- Featured blog post-->
            <div class="card mb-4">
                <a href="/artikel/{{ $articles[0]->slug }}"><img class="card-img-top" src="{{ asset('images/' . $articles[0]->gambar) }}" /></a>
                <div class="card-body">
                    ...
                    <a class="btn btn-primary" href="/artikel/{{ $articles[0]->slug }}">Read more →</a>
                    <div class="mt-3">
        ...
        @else
            <h3>tidak adartikel yang ditemukan</h3>
        @endif
        <!-- Pagination-->
        {{ $articles->links() }}
    </div>
